 ...
 * </pre>
 */
public final class UtilsRawReflect {

    private static Method forName = null;
    private static Method forNameClassLoader = null;
    ...
    static {
        try {
            ...
            forNameClassLoader = Class.class.getDeclaredMethod("forName", String.class,boolean.class,ClassLoader.class);
    ...
    private UtilsRawReflect(final Class<?> type) {
        this(type, type);
    }

    private UtilsRawReflect(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @return the single {@link UtilsRawReflect} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static UtilsRawReflect reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static UtilsRawReflect reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static UtilsRawReflect reflect(final Class<?> clazz)
            throws ReflectException {
        return new UtilsRawReflect(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static UtilsRawReflect reflect(final Object object)
            throws ReflectException {
        return new UtilsRawReflect(object == null ? Object.class : object.getClass(), object);
    }

    private static Class<?> forName(String className) {
        try {
            return (Class<?>) forName.invoke(null, new Object[]{className});
        } catch (Throwable e) {
    ...
    private static Class<?> forName(String name, ClassLoader classLoader) {
        try {
            return (Class<?>) forNameClassLoader.invoke(null, new Object[]{name, true, classLoader});
        } catch (Throwable e) {
            throw new ReflectException(e);
        }
    }
     ...
     * @return the single {@link UtilsRawReflect} instance
     */
    public UtilsRawReflect newInstance() {
     ...
     * @return the single {@link UtilsRawReflect} instance
     */
    public UtilsRawReflect newInstance(Object... args) {
        Class<?>[] types = getArgsType(args);
        try {
            Constructor<?> constructor = (Constructor<?>) getDeclaredConstructor.invoke(type(), new Object[]{types});
    ...
    private UtilsRawReflect newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new UtilsRawReflect(
                    constructor.getDeclaringClass(),
                    newInstance.invoke(accessible(constructor), new Object[]{args})
            );
        } catch (Exception e) {
            throw new ReflectException(e);
        }
     ...
     * @return the single {@link UtilsRawReflect} instance
     */
    public UtilsRawReflect field(final String name) {
        try {
            Field field = getField(name);
            return new UtilsRawReflect(field.getType(), field.get(object));
     ...
     * @return the single {@link UtilsRawReflect} instance
     */
    public UtilsRawReflect field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Field getAccessibleField(String name) {
        Class<?> type = type();
        try {
            return (Field) accessible((AccessibleObject) getField.invoke(type, new Object[]{name}));
        } catch (Throwable e) {
            do {
                try {
                    return (Field) accessible((AccessibleObject) getDeclaredField.invoke(type, new Object[]{name}));
    ...
    private Object unwrap(Object object) {
        if (object instanceof UtilsRawReflect) {
            return ((UtilsRawReflect) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public UtilsRawReflect method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public UtilsRawReflect method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private UtilsRawReflect method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    private Method exactMethod(final String name, final Class<?>[] types)
        ...
        Class<?> type = type();
        try {
            return (Method) getMethod.invoke(type,new Object[]{name,types});
        } catch (Throwable e) {
            do {
                try {
                    return (Method) getDeclaredMethod.invoke(type,new Object[]{name,types});
                } catch (Throwable ignore) {
                }
                type = type.getSuperclass();
            } while (type != null);
    ...
    public boolean equals(Object obj) {
        return obj instanceof UtilsRawReflect && object.equals(((UtilsRawReflect) obj).get());
    }
